...
Лучше сначала проинициализировать хранилище через консоль [Git](../../Общие%20знания/Git.md) сделать commit, соединиться с сервером GitHab, сделать push, проверить что все работает, а Потом уже использовать команды плагина через Ctr+P
...
3. ![Jupyter](_attachments/Pasted%20image%2020211029174140.png)
